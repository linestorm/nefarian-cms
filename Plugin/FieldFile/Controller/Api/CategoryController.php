...
namespace Nefarian\CmsBundle\Plugin\FieldFile\Controller\Api;
...
class CategoryController extends AbstractApiController
{
    ...
    {
        return 'Nefarian\CmsBundle\Plugin\FieldFile\Entity\NodeCategory';
    }
    ...
    function getUrl($method, $entity = null)
    {
        switch($method)
        {
            case self::METHOD_POST:
                return $this->generateUrl('nefarian_api_field_file_post_category');
                break;

            case self::METHOD_PUT:
                return $this->generateUrl('nefarian_api_field_file_put_category', array( 'id' => $entity->getId() ));
                break;

            case self::METHOD_DELETE:
                return $this->generateUrl('nefarian_api_field_file_delete_category', array( 'id' => $entity->getId() ));
                break;

            case self::METHOD_GET:
                return $this->generateUrl('nefarian_plugin_field_file_category_edit', array( 'id' => $entity->getId() ));
                break;
        }
